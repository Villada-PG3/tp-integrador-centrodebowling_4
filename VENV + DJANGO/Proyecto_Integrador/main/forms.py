...
class ReservaForm(forms.ModelForm):
    ...
    email_cliente = forms.EmailField(label='Correo electrónico ', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'el correo que usaste para Iniciar Sesion'}))
